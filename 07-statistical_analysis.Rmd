...
sd(versicolor.petal.width) # standard deviation
var(versicolor.petal.width) # variance
```
...
virginica.petal.length <- get_iris_data("virginica", "Petal.Length")
```

Calculate the interquartile range
```{r}
print("INTERQUARTILE RANGE")
print(paste("Setosa Petal Width:", IQR(setosa.petal.width)))
print(paste("Setosa Petal Length:", IQR(setosa.petal.length)))
print(paste("Versicolor Petal Width:", IQR(versicolor.petal.width)))
print(paste("Versicolor Petal Length:", IQR(versicolor.petal.length)))
print(paste("Virginica Petal Width:", IQR(virginica.petal.width)))
print(paste("virginica Petal Length:", IQR(virginica.petal.length)))
```

Calculate range
```{r}
print("RANGE")
print(paste("Setosa Petal Width:", range(setosa.petal.width)))
print(paste("Setosa Petal Length:", range(setosa.petal.length)))
print(paste("Versicolor Petal Width:", range(versicolor.petal.width)))
print(paste("Versicolor Petal Length:", range(versicolor.petal.length)))
print(paste("Virginica Petal Width:", range(virginica.petal.width)))
print(paste("virginica Petal Length:", range(virginica.petal.length)))
```
...
ggcorrplot(cor_matrix, method = "circle", type = "lower", lab = TRUE, title = "Correlation Heatmap")
...
model <- lm(MEDV ~ . , data = boston_df)

summary(model)
```


The multiple linear regression model explains 73.4% of the variance in house prices (Adjusted R-squared = 0.7338). Significant predictors include crime rate (CRIM), room count (RM), and distance to employment (DIS), among others
...
<span style="color: brown;">**Formulation of Hypothesis**</span> 
