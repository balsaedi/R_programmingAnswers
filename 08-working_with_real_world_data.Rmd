...
ii. Create a copy of the data set and rename it `subset_df1_copy`. Drop rows that contain any null value. 
iii. Create another copy, `subset_df1_copy2` and impute the missing values based on the previous value. `.direction=down`. 
